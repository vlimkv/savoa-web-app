...
// --- DATA ---
const AFFIRMATIONS = [
  // Исходные (для сохранения контекста)
  ...
  // Отношения с телом и принятие
  "Я учусь дружить со своим телом заново каждый день.",
  "Мой вес и формы не определяют мою ценность как личности.",
  "Я благодарна своему телу за всё, что оно делает для меня ежесекундно.",
  "Я смотрю на себя в зеркало с добротой и принятием.",
  "В моём теле достаточно места для моих чувств.",
  "Я принимаю изменения в своём теле как естественную часть жизни.",
  "Я перестаю сравнивать своё тело с другими. Мой путь уникален.",
  "Я прикасаюсь к себе с любовью и нежностью.",
  "Моё тело — это мой дом, и я создаю в нём уют.",
  "Я уважаю границы своего тела и не переступаю их ради других.",
  "Я даю своему телу именно то питание, которое дарит ему энергию.",
  "Движение для меня — это радость, а не наказание за съеденное.",
  "Я чувствую красоту в своей естественности.",
  "Я позволяю своему животу быть мягким и расслабленным.",
  "Моя женственность не требует доказательств, она просто есть.",

  // Отдых, замедление и восстановление
  "Отдых — это не награда за труд, а необходимость для жизни.",
  "Я имею право на паузу, даже если ничего не сделала.",
  "Моя продуктивность не определяет мою значимость.",
  "Я разрешаю себе лениться и просто быть.",
  "Сон и восстановление — мои приоритеты.",
  "Я чувствую разницу между 'надо' и 'могу', и выбираю себя.",
  "Я замедляюсь, чтобы почувствовать вкус жизни.",
  "В тишине я слышу свои истинные желания.",
  "Я отпускаю спешку и суету, выбирая плавность.",
  "Я разрешаю себе быть непродуктивной сегодня.",
  "Восстановление требует времени, и я даю себе это время.",
  "Я выдыхаю усталость и вдыхаю спокойствие.",
  "Я позволяю миру подождать, пока я забочусь о себе.",
  "Мой ресурс восполняется, когда я добра к себе.",
  "Я не должна никому ничего доказывать, даже самой себе.",

  // Эмоции и внутреннее состояние
  "Я разрешаю себе чувствовать всё: и радость, и грусть, и гнев.",
  "Мои эмоции — это сигналы, а не враги.",
  "Я даю место своей тревоге, но не позволяю ей управлять мной.",
  "Я выбираю внутренний мир, даже когда вокруг хаос.",
  "Я прощаю себя за прошлые ошибки и смотрю вперёд.",
  "Я отпускаю потребность всё контролировать.",
  "Внутри меня есть бесконечный источник спокойствия.",
  "Я бережно отношусь к своему сердцу.",
  "Я имею право сказать 'нет', чтобы сказать 'да' себе.",
  "Я не несу ответственность за эмоции других людей.",
  "Я защищаю своё эмоциональное пространство.",
  "Я позволяю себе быть уязвимой, в этом моя сила.",
  "Я достойна поддержки и помощи.",
  "Я обнимаю своего внутреннего ребёнка с любовью.",
  "Моё настроение переменчиво, как погода, и это нормально.",

  // Осознанность и присутствие
  "Я замечаю красоту в простых моментах этого дня.",
  "Я ощущаю опору под ногами и связь с землей.",
  "Я здесь. Я живая. Я есть.",
  "Я перевожу внимание из головы в тело.",
  "Я наслаждаюсь каждым глотком воды и каждым вдохом.",
  "Я осознаю свои потребности до того, как они станут криком.",
  "Я присутствую в своей жизни, а не просто проживаю её.",
  "Я выбираю быть наблюдателем, а не критиком.",
  "Каждый момент — это возможность начать заново.",
  "Я фокусируюсь на том, что я могу изменить здесь и сейчас.",

  // Женское здоровье и циклы
  "Я уважаю цикличность своей природы.",
  "Я прислушиваюсь к ритмам своего организма.",
  "Я почитаю свою матку и область таза как центр жизненной силы.",
  "Я чувствую связь с другими женщинами и женской мудростью.",
  "Я принимаю свою сексуальность и чувственность.",
  "Моё тело способно на удивительные вещи.",
  "Я доверяю интуиции, она — голос моего тела.",
  "Я в гармонии со своими гормонами и циклами.",
  "Я праздную свою способность чувствовать глубоко.",
  "Я исцеляю связь со своей женской сутью.",

  // Доверие и безопасность
  "Мир заботится обо мне, и я в безопасности.",
  "Я доверяю процессу жизни.",
  "Всё происходит вовремя и наилучшим образом.",
  "Я отпускаю страх будущего и доверяю настоящему.",
  "Я окружена любовью и поддержкой Вселенной.",
  "Мне не нужно заслуживать любовь, она принадлежит мне по праву рождения.",
  "Я верю в свою способность справляться с трудностями.",
  "Я открыта для добра и чудес.",
  "Я чувствую себя защищенной в своём теле.",
  "Я выбираю веру вместо сомнений.",

  // Самоценность
  "Я — самое ценное, что у меня есть.",
  "Мои желания важны.",
  "Я достойна самого лучшего просто так.",
  "Я ценю свою уникальность.",
  "Я — автор своей жизни и своего состояния.",
  "Я люблю ту женщину, которой становлюсь.",
  "Я горжусь своими маленькими победами.",
  "Я разрешаю себе сиять.",
  "Мой голос имеет значение.",
  "Я в ладу со своей совестью и душой.",

  // Аффирмации-напоминания (короткие)
  "Дыши.",
  "Ты справляешься.",
  "Всё хорошо.",
  "Ты в безопасности.",
  ...
  // Глубокие телесные настройки
  "Я чувствую, как расслабляется мой таз и живот.",
  "Я направляю дыхание в те участки, где есть напряжение.",
  "Я позволяю своей энергии течь свободно.",
  "Я ощущаю тепло в своих ладонях и стопах.",
  "Мой позвоночник — моя гибкая и прочная опора.",
  "Я чувствую свои границы кожей.",
  "Я наполняюсь светом с каждым вдохом.",
  "Я благодарю свои ноги за то, что они носят меня.",
  "Я благодарю свои руки за то, что они создают и обнимают.",
  "Я благодарю свои глаза за то, что они видят красоту.",

  // Завершающие (утверждающие)
  "Сегодня я выбираю быть на своей стороне.",
  "Я обещаю себе быть бережной сегодня.",
  "Я открываю сердце для благодарности.",
  "Моя жизнь наполнена смыслом и покоем.",
  "Я излучаю спокойствие и уверенность.",
  "Я нахожу баланс между усилием и расслаблением.",
  "Я свободна быть собой.",
  "Я дарю себе безусловное принятие.",
  "Я счастлива жить в этом теле.",
  "Я — это любовь."
];
